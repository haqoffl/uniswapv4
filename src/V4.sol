...
function mintPosition(address _token0,address _token1,uint24 fee, int24 tickSpacing, address hook,uint256 liquidity, uint128 amount0Max, uint128 amount1Max, bytes memory hookData,address permit2) public{
